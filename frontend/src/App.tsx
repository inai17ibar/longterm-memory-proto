...
function App() {
  ...
  const [messages, setMessages] = useState<
    Array<{ user_message: string; ai_response: string }>
  >([]);
  ...
  const [langchainMemories, setLangchainMemories] = useState<
    Array<{
      id: string;
      content: string;
      memory_type: string;
  ...
  const exportConversations = async () => {
    ...
    try {
      ...
      const endpoints = [
        ...
        {
          url: `${API_URL}/api/export-profile/${userId}`,
          name: "ユーザープロファイル",
              ...
              (langchainMemories.length > 0 ? (
                ...
                >
                  ...
                  {userInfo.memory_items &&
                    userInfo.memory_items.length > 0 && (
                      <div>
                        {/* 悩み・心配事 */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "concerns",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
                        ...
                        {/* 性格・特徴 */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "personality",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
                        ...
                        {/* 重要な体験 */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "experiences",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
                        ...
                        {/* 対処法 */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "coping_methods",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
                        ...
                        {/* サポート体制 */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "support_system",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
                        ...
                        {/* 勤務・復職状況 */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "work_status",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
                        ...
                        {/* 日常・生活パターン */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "daily_routine",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
                        ...
                        {/* 感情状態 */}
                        {userInfo.memory_items.filter(
                          (item: any) => item.type === "emotional_state",
                        ).length > 0 && (
                          <div
                            style={{
                              padding: "12px",
