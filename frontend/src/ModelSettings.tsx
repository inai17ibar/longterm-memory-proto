    ...
    <div style={{
      ...
      {message && (
        <div style={{
          padding: '10px',
          marginBottom: '16px',
          backgroundColor: message.includes('失敗') || message.includes('エラー') ? '#fee2e2' : '#d1fae5',
          color: message.includes('失敗') || message.includes('エラー') ? '#dc2626' : '#065f46',
          borderRadius: '8px',
          fontSize: '14px'
        }}>
          {message}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>
            AIの応答の最大長を制御します（日本語で約{Math.floor(maxTokens * 0.6)}文字程度）
          </p>
        </div>
