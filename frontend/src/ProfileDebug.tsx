...
export const ProfileDebug: React.FC<ProfileDebugProps> = ({
  userId,
  apiUrl,
}) => {
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          {userState && (
            ...
            >
              ...
              {/* 文脈パターン */}
              {userState.contextual_patterns &&
                Object.keys(userState.contextual_patterns).length > 0 && (
                  <div style={{ marginTop: "16px" }}>
                    ...
                    {Object.entries(userState.contextual_patterns).map(
                      ([key, value]) => (
                        <div
                          key={key}
                          style={{
